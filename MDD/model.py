...
class Transhemispheric_Fusion_Graph(torch.nn.Module):
    ...
    def _setup(self):
        ...
        self.graph_convolution_r_1 = GCNConv(112,64)
    ...
    def forward(self, data):
        ...
        new_left_edges, new_left_edge_attr = subgraph(subset=leftBrain.type(torch.long), edge_index=edges,
                                                      edge_attr=edge_attr, num_nodes=112)
        ...
        node_features_1 = torch.zeros(112,64).to(opt.device)
        ...
        node_features_2 = torch.zeros(112,20).to(opt.device)
        ...
        inter_channel_adj = features.new_zeros(101,56)
...
class Graph_Embedding_Graph(nn.Module):
    def __init__(self):
        ...
        self.convs.append(TransformerConv(in_channels=2020, out_channels=20, heads=1))
