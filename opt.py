...
class OptInit():
    def __init__(self):
        ...
        parser.add_argument('--beta', default=0.4, type=float, help='adjacency threshold set when building GEmb-GAT')
        parser.add_argument('--k1', default=0.9, type=float, help='the pooling ratio of the Self-Attention Graph Pooling')
        parser.add_argument('--k2', default=0.5, type=float,help='the pooling ratio of the Dense-Diff-Pool')
